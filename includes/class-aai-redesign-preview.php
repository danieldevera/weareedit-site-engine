...
class EDIT_AAI_Redesign_Preview {
     ...
     * splice drops the theme's native one (it sits in the cut body). Reuses
     * the .side-filter-container open mechanism (same as #falaConnosco).
    ...
    private static function inscription_panel( string $live ): string {
        ...
        // that the splice would otherwise drop — extracted verbatim from the
        // live page, NOT rebuilt. '' if not found → CTA falls back to falaConnosco.

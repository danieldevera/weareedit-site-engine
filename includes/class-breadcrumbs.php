...
.edit-breadcrumbs{background:#0a0a0a;border-bottom:1px solid rgba(255,255,255,.06);padding:104px 60px 14px;font-size:13px;line-height:1.4;color:rgba(255,255,255,.55);font-family:inherit;position:relative;z-index:1}
...
@media (max-width:768px){.edit-breadcrumbs{padding:84px 20px 10px;font-size:12px}.edit-breadcrumbs li:not(:last-child)::after{margin:0 6px}}
</style>
        <?php
    }

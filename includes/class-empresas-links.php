...
(function(){
  try{
    ...
    private static function inject_pillar_cta( string $html ): string {
        ...
        $band .= '<p class="ee-empresas-band__body">Desenhamos programas à medida para empresas — presenciais em Lisboa e Porto, nas vossas instalações ou remotos. Certificados DGERT e elegíveis para Fundo de Compensação do Trabalho.</p>';
    ...
    private static function inject_homepage_empresas( string $html ): string {
        ...
        $section .= '<div class="eehe__feat"><span class="eehe__ic"></span><div><b>Fundo de Compensação do Trabalho</b><span>Elegível para financiamento</span></div></div>';

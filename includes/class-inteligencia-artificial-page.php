        ...
        <section class="md-pillar">
            <div class="md-hero">
                <div class="md-hero__inner">
                    ...
                    <h1 class="md-hero__title">Inteligência<br><span>Artificial na EDIT.</span></h1>
                    <p class="md-hero__lede">11 formações DGERT certificadas em IA aplicada — Cinema, Marketing, UX, Web, Produtos Digitais. Bootcamps, workshops e percursos avançados com tutores que usam estas ferramentas em projetos reais.</p>
